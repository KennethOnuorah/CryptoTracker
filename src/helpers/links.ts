...
const NEWS_API_URL = `https://newsapi.org/v2/everything?domains=coindesk.com,decrypt.co,cointelegraph.com,dailycoin.com,cryptonews.com,finance.yahoo.com&pageSize=6&language=en&from=${year}-${month.padStart(2, '0')}-${day.padStart(2, '0')}&sortBy=popularity&apiKey=${apiKey}`
